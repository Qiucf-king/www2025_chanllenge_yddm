...
#         df_ = df_.groupby('file').tail(1000)
        ...
        df_nona['a_1'] = df_nona['a'] - df_nona.groupby('file')['a'].shift(1)

        df_nona['a_6'] = df_nona['v'] - df_nona.groupby('file')['v'].shift(6)
        
        df_nona['d2a_1'] = df_nona['a_1'] - df_nona.groupby('file')['a_1'].shift(1)
        df_nona['d2a_2'] = df_nona['a_1'] - df_nona.groupby('file')['a_1'].shift(2)
