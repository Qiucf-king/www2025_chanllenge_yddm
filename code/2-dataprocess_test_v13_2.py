...
#         df_ = df_.groupby('file').tail(1000)
        ...
        df_nona['a_2'] = df_nona['v'] - df_nona.groupby('file')['v'].shift(2)
        df_nona['a_3'] = df_nona['v'] - df_nona.groupby('file')['v'].shift(3)
        df_nona['a_4'] = df_nona['v'] - df_nona.groupby('file')['v'].shift(4)
